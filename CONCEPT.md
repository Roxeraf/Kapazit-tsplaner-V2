...
Noch nicht umgesetzt: Restaufwand-basierte Hochrechnung (Variante 2), Portal-SSO, der Excel-Migrationslauf für Bestandsdaten, Schritt 9 (Controlling-Erweiterung: Auslastung/KPIs/Reporting) aus Abschnitt 9, der Übersicht-Tab (Schritt 5) sowie der offene Jira-Issues-Endpoint für den Jira-Tab. Siehe Abschnitt 10 für offene Entscheidungen.
