...
def get_utilization(period: str | None = None, db: Session = Depends(get_db)):
    """Auslastungsgrad je Person für eine Periode (Default: aktuelle Periode). Reine
    Aggregation aus ResourceAssignment/Demand und der Available-Capacity-Kalkulation -
    übernommen aus compute_portfolio_utilization (capacity_calc.py), seit dem Legacy
    Cutover (Phase 26.9) periodenscharf statt statisch pro TeamMember."""
