...
> **Hinweis:** Dieses Excel/VBA-Tool wird durch die neue Web-App im Repo-Root
> abgelöst (siehe [`../CONCEPT.md`](../CONCEPT.md) und [`../README.md`](../README.md)).
> Diese Datei bleibt als Referenzdokumentation für den Übergangszeitraum erhalten.
...
../export/PLX_generate_pptx.js   # Node.js-Skript zur PPTX-Generierung
                                  # (jetzt vom neuen Backend aufgerufen)
```
